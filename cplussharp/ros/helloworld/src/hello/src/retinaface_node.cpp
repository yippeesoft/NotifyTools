...
#include "hello/FaceObject.h"
ncnnRetinaface engine;
/////////////////////////////////////

hello::FaceObject faceMsg;
...
//Assets path: .... /cplussharp/ros/helloworld/src/hello/assets/models/
  const std::string package_name = "hello";
  ...
  face_pub = n.advertise<hello::FaceObject>(node_name+"/faces", 10);
  ...
  image_transport::Subscriber video = it.subscribe("/camera/image", 1, boost::bind(&imageCallback, _1, num_threads));
#ifdef GPU_SUPPORT
